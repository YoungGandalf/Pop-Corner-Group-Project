# Generated by Django 3.1.7 on 2021-04-13 20:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MyUser',
            fields=[
                ('UserEmail', models.EmailField(max_length=100, validators=[movies.validators.validate_name_length])),
                ...
                ('UserName', models.CharField(max_length=100, primary_key=True, serialize=False, validators=[movies.validators.validate_name_length, movies.validators.validate_username_alphadigits])),
